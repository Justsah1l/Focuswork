...
class WiseSplashScreen extends StatefulWidget {
  const WiseSplashScreen({required this.controller, super.key});
      ...
      child: FadeTransition(
        ...
        child: Stack(
          ...
          children: [
            ...
            Positioned.fill(child: _Foreground(controller: widget.controller)),
          ],
        ),
      ),
    );
...
class _Clipper extends CustomClipper<Path> {
  _Clipper({required this.progress, required this.expansion})
...
class _Delegate extends SingleChildLayoutDelegate {
  _Delegate({required this.progress, required this.expansion})
...
class _CirclePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(Offset(side * 0.5, side * 0.5), side * 0.5, circlePaint);
...
class _Track {
  const _Track._({required this.path, required this.trackHeadCenter});
  ...
  factory _Track.fromScreenRect({
    ...
    return _Track._(path: path, trackHeadCenter: trackRect.topCenter);
  }
